defmodule TooterWeb.Router do
  ...
  scope "/", TooterWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TooterWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TooterWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TooterWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TooterWeb do
    ...
    live_session :current_user,
      on_mount: [{TooterWeb.UserAuth, :mount_current_user}] do
